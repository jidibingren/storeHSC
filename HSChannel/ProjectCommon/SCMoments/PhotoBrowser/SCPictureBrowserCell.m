...
@interface SCPictureBrowserCell()<UIScrollViewDelegate>
...
@implementation SCPictureBrowserCell
...
//    [self.imageView cancelImageRequestOperation];
    ...
    if (self.picture.url) {
        ...
        [self.imageView sd_setImageWithURL:self.picture.url placeholderImage:nil completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
