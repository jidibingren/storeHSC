...
#import "HSCMinefeedbackController.h"

@interface HSCMinefeedbackController ()

@property (nonatomic, strong)TPKeyboardAvoidingScrollView *scrollView;

@end

@implementation HSCMinefeedbackController
...
- (void)setupScrollView{
    ...
    textView.placeholder = @"请输入您的宝贵意见，建议...";
    ...
    [confirmBtn bk_whenTapped:^{
        ...
        if (![Utils isValidStr:_contentTextView.text]) {
            return ;
        }
        
        [SCHttpTool postWithURL:HSC_URL_SUGGEST_ADD params:@{@"suggest":_contentTextView.text} success:^(NSDictionary *json) {
