...
@implementation HSCCNViewController

- (void)viewDidLoad{
    
    self.url = HSC_URL_CLASS_NOTICE_LIST;
...
- (void)setupNavigationBar{
    ...
    [rightBtn bk_whenTapped:^{
        ...
        [self.navigationController pushViewController:[[HSCClassPublishController alloc]initWithType:HSCClassPublishNotice] animated:YES];
...
- (void)didClickDeleteButtonInCell:(SCMomentsCell *)cell{
    ...
    [SCHttpTool postWithURL:HSC_URL_CLASS_NOTICE_DEL params:params success:^(NSDictionary *json) {
